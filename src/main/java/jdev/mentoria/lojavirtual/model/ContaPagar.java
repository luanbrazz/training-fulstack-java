...
public class ContaPagar implements Serializable {
    ...
    @ManyToOne(targetEntity = Pessoa.class)
    @JoinColumn(
            name = "pessoa_forn_id", // Nome da coluna no banco de dados que armazenará a chave estrangeira.
            nullable = false,   // Indica que a coluna "pessoa_id" não pode conter valores nulos.
            foreignKey = @ForeignKey(
                    value = ConstraintMode.CONSTRAINT, // Define o modo de restrição da chave estrangeira.
                    name = "pessoa_forn_fk" // Nome da restrição de chave estrangeira no banco de dados.
            )
    )
